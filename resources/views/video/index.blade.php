        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="form-inline my-2 my-lg-0">
                    <a class="btn btn-success" href="{{ route('videos.create') }}">Add</a>
                    @csrf
    ...
    <div class="container text-center">
        ...
        @foreach ($videos as $video)
            <div class="position-relative d-inline-block">
                ...
                <form action="{{ route('videos.destroy',$video->id) }}" method="POST" class="position-absolute" style="top: 10px; right: 10px;">
                    @csrf
                    @method('DELETE')
